...
from .base_dataclass import BasePlaneState, BaseControlState, _register_dataclass_pytree
...
_register_dataclass_pytree(FighterPlaneState)
...
_register_dataclass_pytree(FighterPlaneControlState)
